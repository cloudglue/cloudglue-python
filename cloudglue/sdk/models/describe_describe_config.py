...
class DescribeDescribeConfig(BaseModel):
    ...
    prompt: Optional[StrictStr] = Field(default=None, description="The free-form guidance this description was produced under, echoed back. Absent when none was supplied.")
    __properties: ClassVar[List[str]] = ["enable_summary", "enable_speech", "enable_visual_scene_description", "enable_scene_text", "enable_audio_description", "participants", "prompt"]
