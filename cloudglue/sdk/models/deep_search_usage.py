...
class DeepSearchUsage(BaseModel):
    ...
    search_calls: Optional[StrictInt] = Field(default=None, description="Number of search calls made")
    __properties: ClassVar[List[str]] = ["input_tokens", "output_tokens", "total_tokens", "search_calls"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeepSearchUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeepSearchUsage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "search_calls": obj.get("search_calls")
        })
        return _obj
