...
class File(BaseModel):
    ...
    def source_validate_enum(cls, value):
        ...
        if value not in set(['video', 'youtube', 's3', 'dropbox', 'http', 'upload', 'google-drive', 'zoom', 'gong', 'recall', 'gcs', 'grain']):
            raise ValueError("must be one of enum values ('video', 'youtube', 's3', 'dropbox', 'http', 'upload', 'google-drive', 'zoom', 'gong', 'recall', 'gcs', 'grain')")
        return value
