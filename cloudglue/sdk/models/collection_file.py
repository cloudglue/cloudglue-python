...
class CollectionFile(BaseModel):
    ...
    searchable_status: Optional[StrictStr] = Field(default=None, description="Indexing status of the file's search documents in this collection. Only present for media-descriptions, rich-transcripts, metadata, and entities collections. For entities collections it tracks entity indexing: file-level collections index one document per file, segment-level collections one per segment.")
    file: Optional[File] = None
    segmentation: Optional[CollectionFileSegmentation] = None
    __properties: ClassVar[List[str]] = ["collection_id", "file_id", "object", "added_at", "status", "searchable_status", "file", "segmentation"]
