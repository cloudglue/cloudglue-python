...
class WebhookEvents(str, Enum):
    ...
    FIND_MOMENTS_DOT_JOB_DOT_PROCESSING = 'find_moments.job.processing'
    FIND_MOMENTS_DOT_JOB_DOT_COMPLETED = 'find_moments.job.completed'
    FIND_MOMENTS_DOT_JOB_DOT_FAILED = 'find_moments.job.failed'
