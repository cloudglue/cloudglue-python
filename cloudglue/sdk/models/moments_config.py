...
class MomentsConfig(BaseModel):
    ...
    """ # noqa: E501
    criteria: Annotated[List[NewMomentCriterionAttachment], Field(min_length=1)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MomentsConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MomentsConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "criteria": [NewMomentCriterionAttachment.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None
        })
        return _obj
