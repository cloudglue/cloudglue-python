...
class SegmentationShotDetectorConfig(BaseModel):
    ...
    min_seconds: Optional[Union[Annotated[float, Field(le=600, strict=True, ge=0.6)], Annotated[int, Field(le=600, strict=True, ge=1)]]] = Field(default=None, description="The minimum length of a shot in seconds. Defaults to 0.6.")
