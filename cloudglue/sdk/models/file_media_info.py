...
class FileMediaInfo(BaseModel):
    ...
    width: Optional[StrictInt] = Field(default=None, description="Width in pixels (null for audio files)")
    height: Optional[StrictInt] = Field(default=None, description="Height in pixels (null for audio files)")
