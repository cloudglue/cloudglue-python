...
class NewCollection(BaseModel):
    ...
    moments_config: Optional[MomentsConfig] = None
    ...
    __properties: ClassVar[List[str]] = ["collection_type", "moments_config", "name", "description", "describe_config", "extract_config", "transcribe_config", "default_segmentation_config", "default_thumbnails_config", "face_detection_config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "moments_config": MomentsConfig.from_dict(obj["moments_config"]) if obj.get("moments_config") is not None else None,
            "name": obj.get("name"),
