...
class RichTranscript(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["visual_scene_description", "scene_text", "speech", "audio_description", "collection_id", "file_id", "content", "title", "summary", "duration_seconds", "segment_summary", "file"]
