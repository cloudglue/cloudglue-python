...
class DataConnector(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['s3', 'dropbox', 'google-drive', 'zoom', 'gong', 'recall', 'gcs', 'grain', 'iconik']):
            raise ValueError("must be one of enum values ('s3', 'dropbox', 'google-drive', 'zoom', 'gong', 'recall', 'gcs', 'grain', 'iconik')")
        return value
