...
class Collection(BaseModel):
    ...
    def collection_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['media-descriptions', 'entities', 'rich-transcripts', 'face-analysis', 'metadata']):
            raise ValueError("must be one of enum values ('media-descriptions', 'entities', 'rich-transcripts', 'face-analysis', 'metadata')")
        return value
