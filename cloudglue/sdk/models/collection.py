...
class Collection(BaseModel):
    ...
    moments_config: Optional[CollectionMomentsConfig] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "object", "name", "description", "collection_type", "moments_config", "extract_config", "transcribe_config", "describe_config", "default_segmentation_config", "default_thumbnails_config", "face_detection_config", "created_at", "file_count"]
    ...
    def collection_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['media-descriptions', 'entities', 'rich-transcripts', 'face-analysis', 'metadata', 'moments']):
            raise ValueError("must be one of enum values ('media-descriptions', 'entities', 'rich-transcripts', 'face-analysis', 'metadata', 'moments')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of moments_config
        if self.moments_config:
            _dict['moments_config'] = self.moments_config.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "moments_config": CollectionMomentsConfig.from_dict(obj["moments_config"]) if obj.get("moments_config") is not None else None,
