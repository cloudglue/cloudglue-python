...
class MediaDescription(BaseModel):
    ...
    file: Optional[File] = Field(default=None, description="The file this document describes. `metadata` and `source_metadata` are only included when `include_metadata` is true.")
    __properties: ClassVar[List[str]] = ["visual_scene_description", "scene_text", "speech", "audio_description", "collection_id", "file_id", "thumbnail_url", "content", "title", "summary", "duration_seconds", "segment_summary", "chapters", "shots", "total_chapters", "total_shots", "file"]
