...
class SearchFilter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metadata", "video_info", "file", "source_metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.file:
            ...
            _dict['file'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in source_metadata (list)
        _items = []
        if self.source_metadata:
            for _item_source_metadata in self.source_metadata:
                if _item_source_metadata:
                    _items.append(_item_source_metadata.to_dict())
            _dict['source_metadata'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source_metadata": [SearchFilterCriteria.from_dict(_item) for _item in obj["source_metadata"]] if obj.get("source_metadata") is not None else None
        })
        return _obj
