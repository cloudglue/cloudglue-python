...
class FilesApi:
    ...
    def sync_file_from_url(
        self,
        sync_file_from_url_request: SyncFileFromUrlRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Materialize a publicly accessible URL into a Cloudglue file without a data connector or a collection. Accepts direct http(s) video/audio file URLs (e.g. `.mp4`), public Dropbox share links, TikTok video URLs, and Loom share URLs. Idempotent: syncing the same URL returns the existing file. YouTube URLs are not supported here — add them to a collection via the add-media endpoint instead. Connector-native URIs (e.g. `s3://`, `gs://`, `gdrive://`, Zoom/Gong/Recall/Grain links) require the matching data connector — use POST /data-connectors/{id}/sync.

        :param sync_file_from_url_request: (required)
        :type sync_file_from_url_request: SyncFileFromUrlRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._sync_file_from_url_serialize(
            sync_file_from_url_request=sync_file_from_url_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def sync_file_from_url_with_http_info(
        self,
        sync_file_from_url_request: SyncFileFromUrlRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def sync_file_from_url_without_preload_content(
        self,
        sync_file_from_url_request: SyncFileFromUrlRequest,
        _request_timeout: Union[
            None,
    ...
    def _sync_file_from_url_serialize(
        self,
        sync_file_from_url_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if sync_file_from_url_request is not None:
            _body_params = sync_file_from_url_request
    ...
    @validate_call
    def sync_file_source_metadata(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID of the file to sync")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param file_id: The ID of the file to sync (required)
        :type file_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._sync_file_source_metadata_serialize(
            file_id=file_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def sync_file_source_metadata_with_http_info(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID of the file to sync")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def sync_file_source_metadata_without_preload_content(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID of the file to sync")],
        _request_timeout: Union[
            None,
    ...
    def _sync_file_source_metadata_serialize(
        self,
        file_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/files/{file_id}/sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def upload_file(
        self,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="The video, audio, or image file to be uploaded")],
        ...
        :param file: The video, audio, or image file to be uploaded (required)
        :type file: bytearray
