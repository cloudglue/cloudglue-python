...
class CollectionsApi:
    ...
    @validate_call
    def create_collection_moment_criterion(
        self,
        collection_id: StrictStr,
        new_moment_criterion_attachment: NewMomentCriterionAttachment,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type collection_id: str
        :param new_moment_criterion_attachment: (required)
        :type new_moment_criterion_attachment: NewMomentCriterionAttachment
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_collection_moment_criterion_serialize(
            collection_id=collection_id,
            new_moment_criterion_attachment=new_moment_criterion_attachment,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_collection_moment_criterion_with_http_info(
        self,
        collection_id: StrictStr,
        new_moment_criterion_attachment: NewMomentCriterionAttachment,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MomentCriterionAttachment]:
        """Attach a criterion to a moments collection
    ...
    @validate_call
    def create_collection_moment_criterion_without_preload_content(
        self,
        collection_id: StrictStr,
        new_moment_criterion_attachment: NewMomentCriterionAttachment,
        _request_timeout: Union[
    ...
    def _create_collection_moment_criterion_serialize(
        self,
        collection_id,
        new_moment_criterion_attachment,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if new_moment_criterion_attachment is not None:
            _body_params = new_moment_criterion_attachment
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/collections/{collection_id}/moment-criteria',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_collection_moment_criterion(
        self,
        collection_id: StrictStr,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> DeleteCollectionMomentCriterion200Response:
        ...
        _param = self._delete_collection_moment_criterion_serialize(
            collection_id=collection_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DeleteCollectionMomentCriterion200Response",
            '400': "Error",
            '404': "Error",
            '500': "Error",
        }
    ...
    @validate_call
    def delete_collection_moment_criterion_with_http_info(
        self,
        collection_id: StrictStr,
        attachment_id: StrictStr,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteCollectionMomentCriterion200Response]:
        """Detach a criterion from a moments collection
    ...
    @validate_call
    def delete_collection_moment_criterion_without_preload_content(
        self,
        collection_id: StrictStr,
        attachment_id: StrictStr,
        _request_timeout: Union[
    ...
    def _delete_collection_moment_criterion_serialize(
        self,
        collection_id,
        attachment_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/collections/{collection_id}/moment-criteria/{attachment_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_media_descriptions(
        ...
        include_chapters: Annotated[Optional[StrictBool], Field(description="Include narrative chapters in the response (when segmentation strategy is 'narrative')")] = None,
        include_shots: Annotated[Optional[StrictBool], Field(description="Include shot boundaries in the response (when segmentation strategy is 'shot-detector')")] = None,
        include_metadata: Annotated[Optional[StrictBool], Field(description="Include the file's user-defined metadata and source metadata. In markdown these render as a `## Metadata` section; in JSON they populate `file.metadata` and `file.source_metadata`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param include_shots: Include shot boundaries in the response (when segmentation strategy is 'shot-detector')
        :type include_shots: bool
        :param include_metadata: Include the file's user-defined metadata and source metadata. In markdown these render as a `## Metadata` section; in JSON they populate `file.metadata` and `file.source_metadata`.
    ...
    @validate_call
    def list_collection_moment_findings(
        self,
        collection_id: StrictStr,
        ...
        _param = self._list_collection_moment_findings_serialize(
            collection_id=collection_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CollectionMomentFindingsList",
            '400': "Error",
            '404': "Error",
            '500': "Error",
        }
    ...
    @validate_call
    def list_collection_moment_findings_with_http_info(
        self,
        collection_id: StrictStr,
        criterion_name: Optional[StrictStr] = None,
        file_id: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CollectionMomentFindingsList]:
        """List findings in a moments collection
    ...
    @validate_call
    def list_collection_moment_findings_without_preload_content(
        self,
        collection_id: StrictStr,
        criterion_name: Optional[StrictStr] = None,
        file_id: Optional[StrictStr] = None,
    ...
    def _list_collection_moment_findings_serialize(
        self,
        collection_id,
        criterion_name,
        file_id,
        ...
        if criterion_name is not None:
            ...
            _query_params.append(('criterion_name', criterion_name))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/{collection_id}/moments/findings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_collection_moments(
        self,
        collection_id: StrictStr,
        criterion_name: Optional[StrictStr] = None,
        attachment_id: Optional[StrictStr] = None,
        file_id: Annotated[Optional[StrictStr], Field(description="Restrict to one video.")] = None,
        min_score: Optional[Union[StrictFloat, StrictInt]] = None,
        sort: Annotated[Optional[StrictStr], Field(description="criterion_score and rank_score require a single-criterion filter.")] = None,
        limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        cursor: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        :param attachment_id:
        :type attachment_id: str
        :param file_id: Restrict to one video.
        :type file_id: str
        :param min_score:
        :type min_score: float
        :param sort: criterion_score and rank_score require a single-criterion filter.
        :type sort: str
        :param limit:
        :type limit: int
        :param cursor:
        ...
        _param = self._list_collection_moments_serialize(
            collection_id=collection_id,
            criterion_name=criterion_name,
            attachment_id=attachment_id,
            file_id=file_id,
    ...
    @validate_call
    def list_collection_moments_with_http_info(
        self,
        collection_id: StrictStr,
        criterion_name: Optional[StrictStr] = None,
        attachment_id: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CollectionMomentsList]:
        """List moments in a moments collection
    ...
    @validate_call
    def list_collection_moments_without_preload_content(
        self,
        collection_id: StrictStr,
        criterion_name: Optional[StrictStr] = None,
        attachment_id: Optional[StrictStr] = None,
    ...
    def _list_collection_moments_serialize(
        self,
        collection_id,
        criterion_name,
        attachment_id,
        ...
        if attachment_id is not None:
            ...
            _query_params.append(('attachment_id', attachment_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/{collection_id}/moments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
